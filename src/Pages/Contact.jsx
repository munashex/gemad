   ...
   <div className="m-2 md:m-5 mx-4 md:mx-9 my-9 md:my-12 grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="flex flex-col gap-y-6 col">
     <span className="inline-flex items-center space-x-2">
      ...
      <h1 className="text-lg md:text-xl  font-bold">Mareu Buildings 5 Samuel Rd, Delmas, 2210</h1>
     </span>
     <span className="inline-flex items-center space-x-2">
      <FaPhoneAlt color="#81551c" size={27} />
      <a href="tel:+27720270434" className="text-lg  font-bold hover:text-[#81551c] md:text-xl decoration underline">+2772 027 0434</a>
     </span>
     <span className="inline-flex items-center space-x-2">
      <SiMinutemailer color="#81551c" size={27} />
      <a href="mailto:gijimanim@gemad.co.za" className="text-lg md:text-xl font-bold  decoration underline hover:text-[#81551c]">gijimanim@gemad.co.za</a>
     </span>
    </div>
